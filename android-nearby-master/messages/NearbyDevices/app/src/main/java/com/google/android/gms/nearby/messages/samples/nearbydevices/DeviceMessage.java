...
public class DeviceMessage {
     ...
     */
    public static Message newNearbyMessage(String instanceId, String messageContent, int hopCount) {
        DeviceMessage deviceMessage = new DeviceMessage(instanceId, messageContent, hopCount);
    ...
    private DeviceMessage(String uuid, String messageContent, int hopCount) {
        mUUID = uuid;
        mMessageBody = messageContent;
